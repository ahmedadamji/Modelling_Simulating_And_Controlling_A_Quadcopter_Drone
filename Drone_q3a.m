...
%         plt_zdot
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function obj = Drone_q3a(axis1, axis2, axis3, spaceDim, num_drones)
            if nargin > 1
                obj.axis = axis1;
...
%                 obj.posdot_axis = axis4;
                ...
                obj.spaceLimits = [(-2*spaceDim/2)+10 (2*spaceDim/2)-10 (-2*spaceDim/2)+10 (2*spaceDim/2)-10 10 2*spaceDim-10];
...
%                 obj.plt_zdot = [0];
                ...
                %obj.K_eigenvalues = [0.10; 0.05; 0.02; 0.01; 0.06; 0.15; 0.12; 0.04; 0.03; 0.14; 0.90; 0.13];
                %obj.K_eigenvalues = [0.50; 0.53; 0.47; 0.48; 0.51; 0.56; 0.45; 0.55; 0.57; 0.46; 0.54; 0.49];
...
%             hold(obj.posdot_axis,'off');
        ...
        function obj = change_pos_and_orientation(obj)
            ...
            obj.X = [obj.pos(1),obj.pos(2),obj.pos(3),obj.posdot(1),obj.posdot(2),obj.posdot(3),obj.theta(1),...
                obj.theta(2),obj.theta(3),obj.omega(1),obj.omega(2),obj.omega(3)];
